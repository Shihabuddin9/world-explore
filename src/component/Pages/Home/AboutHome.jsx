        ...
        <div className="flex justify-center items-center mt-28">
            <div className="xl:w-4/5 md:w-full mx-5 xl:mx-0 lg:flex">
                ...
                <div className="lg:w-6/12 flex mt-10 lg:mt-0">
                    <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1200" className="relative lg:w-[261px] w-full h-[330.38px] hover01 column overflow-hidden">
                        <figure>
                            <img
                        ...
                        <h1 className="absolute xl:bottom-4 md:bottom-12 bottom-32 left-4 text-white text-2xl bg-black bg-opacity-[0.2]  p-2 ">Travel around the world</h1>
                    </div>
                    <div className="relative lg:w-[261px] w-full h-[330.38px] overflow-hidden lg:mt-12 ml-6 hover01 column">
                        <div data-aos="fade-up" data-aos-delay="400" data-aos-duration="1200">
                            ...
                            <h1 className="absolute xl:bottom-4 md:bottom-12 bottom-32 left-4 text-white text-2xl bg-black bg-opacity-[0.2] p-2 rounded">Your favorite sea beach</h1>
                        </div>
                    </div>
                </div>
            </div>
